...
<head>
    ...
    <link rel="stylesheet" href="../bruckerCopia/css/comprar.css">
      ...
      <div class="col-lg-10 container-fluid">
        ...
        <div class="collapse navbar-collapse navbar-style" id="navbarSupportedContent">
          <ul class="navbar-nav ms-auto justify-content-end">
            ...
            <li class="nav-item">
              <a class="nav-link" href="../bruckerCopia/propiedadesBrucker.php"><b>Propiedades</b></a>
            </li>
            <li class="nav-item">
        ...
        <div class="row row-cols-1 row-cols-md-3 g-4">
          <div class="col">
            <div class="card h-100" data-aos="fade-down">
              <img src="../bruckerCopia/img/img-comprar/paso1.jpg" class="card-img-top" alt="Persona en notebook">
              <div class="card-body">
          ...
          <div class="col">
            <div class="card h-100" data-aos="fade-down">
              <img src="../bruckerCopia/img/img-comprar/paso2.jpg" class="card-img-top" alt="Análisis y cálculos">
              <div class="card-body">
          ...
          <div class="col">
            ...
            data-aos-duration="1500">
              <img src="../bruckerCopia/img/img-comprar/paso3.jpg" class="card-img-top" alt="Personas analizando">
              <div class="card-body">
          ...
          <div class="col">
            <div class="card h-100" data-aos="fade-down">
              <img src="../bruckerCopia/img/img-comprar/paso4.jpg" class="card-img-top" alt="Visitas guiadas">
              <div class="card-body">
          ...
          <div class="col">
            <div class="card h-100" data-aos="fade-down">
              <img src="../bruckerCopia/img/img-comprar/paso5.jpg" class="card-img-top" alt="Manos estrechadas">
              <div class="card-body">
          ...
          <div class="col">
            ...
            data-aos-easing="linear"
            data-aos-duration="1500">
              <img src="../bruckerCopia/img/img-comprar/paso6.jpg" class="card-img-top" alt="Buscando en carpetas">
              <div class="card-body">
          ...
          <div class="col">
            <div class="card h-100" data-aos="fade-down">
              <img src="../bruckerCopia/img/img-comprar/paso7.jpg" class="card-img-top" alt="firma">
              <div class="card-body">
          ...
          <div class="col">
            <div class="card h-100" data-aos="fade-down">
              <img src="../bruckerCopia/img/img-comprar/paso8.jpg" class="card-img-top" alt="Mudanza">
              <div class="card-body">
          ...
          <div class="col">
            ...
            data-aos-easing="linear"
            data-aos-duration="1500" >
              <img src="../bruckerCopia/img/logo/PNG/sinFondocompleto.png" class="card-img-top" alt="Logo de Brücker">           
            </div>
          </div>
        </div>
      </div>
